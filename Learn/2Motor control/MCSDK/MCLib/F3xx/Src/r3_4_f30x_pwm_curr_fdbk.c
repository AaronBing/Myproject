...
{
  R3_4_F30XOPAMPParams_t const * pDOPAMPParams_str = pHandle->pParams_str->pOPAMPParams;
  ...
  if ( ( uint32_t )pHandle == ( uint32_t )&pHandle->_Super )
  {
    ...
    pHandle->wADC_JSQR_phA = R3_4_F30X_ADC_InjectedChannelConfig( ADCx_1, pHandle->pParams_str->bIaChannel, 1u,
                             pHandle->pParams_str->b_IaSamplingTime, 1u, LL_ADC_INJ_TRIG_EXT_RISING, pHandle->ADC_ExternalTriggerInjected );
    pHandle->wADC_JSQR_phB = R3_4_F30X_ADC_InjectedChannelConfig( ADCx_2, pHandle->pParams_str->bIbChannel, 1u,
                             pHandle->pParams_str->b_IbSamplingTime, 1u, LL_ADC_INJ_TRIG_EXT_RISING, pHandle->ADC_ExternalTriggerInjected );
    pHandle->wADC_JSQR_phC = R3_4_F30X_ADC_InjectedChannelConfig( ADCx_2, pHandle->pParams_str->bIcChannel, 1u,
                             pHandle->pParams_str->b_IcSamplingTime, 1u, LL_ADC_INJ_TRIG_EXT_RISING, pHandle->ADC_ExternalTriggerInjected );
    R3_4_F30X_ADC_InjectedChannelConfig( ADCx_2, pHandle->pParams_str->bIaChannel, 1u,
                                         pHandle->pParams_str->b_IaSamplingTime, 1u, LL_ADC_INJ_TRIG_EXT_RISING, pHandle->ADC_ExternalTriggerInjected );
    R3_4_F30X_ADC_InjectedChannelConfig( ADCx_1, pHandle->pParams_str->bIbChannel, 1u,
                                         pHandle->pParams_str->b_IbSamplingTime, 1u, LL_ADC_INJ_TRIG_EXT_RISING, pHandle->ADC_ExternalTriggerInjected );
    R3_4_F30X_ADC_InjectedChannelConfig( ADCx_1, pHandle->pParams_str->bIcChannel, 1u,
                                         pHandle->pParams_str->b_IcSamplingTime, 1u, LL_ADC_INJ_TRIG_EXT_RISING, pHandle->ADC_ExternalTriggerInjected );
 ...
 * @retval none
 */
void * R3_4_F30X_TIMx_UP_IRQHandler( PWMC_R3_4_F3_Handle_t * pHandle )
{
 ...
 * @retval none
 */
void * R3_4_F30X_BRK2_IRQHandler( PWMC_R3_4_F3_Handle_t * pHandle )
{
 ...
 * @retval none
 */
void * R3_4_F30X_BRK_IRQHandler( PWMC_R3_4_F3_Handle_t * pHandle )
{
...
static uint32_t R3_4_F30X_ADC_InjectedChannelConfig( ADC_TypeDef * ADCx, uint8_t ADC_Channel, uint8_t Rank,
    uint8_t ADC_SampleTime, uint8_t SequencerLength, uint16_t ADC_ExternalTriggerInjectedPolarity,
    uint16_t ADC_ExternalTriggerInjected )
{
...
void R3_4_F30X_RLDetectionModeEnable( PWMC_Handle_t * pHdl )
{
  ...
  if ( pHandle->_Super.RLDetectionMode == false )
  {
    ...
    TIMx->CCER |= LL_TIM_CHANNEL_CH4;
    LL_TIM_SetTriggerOutput2( TIMx, LL_TIM_TRGO2_OC3);
...
void RLTurnOnLowSidesAndStart( PWMC_Handle_t * pHdl )
{
  ...
  ADCx_1->JSQR = pHandle->wADC_JSQR_phA;
  ADCx_2->JSQR = pHandle->wADC_JSQR_phB;
