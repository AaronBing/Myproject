...
/**
  ...
  * @retval none
  */
void * R1F30X_TIMx_UP_IRQHandler( PWMC_R1_F3_Handle_t * pHandle )
{
...
/**
  ...
  * @retval none
  */
void * R1F30X_BRK2_IRQHandler( PWMC_R1_F3_Handle_t * pHandle )
{
...
/**
  ...
  * @retval none
  */
void * R1F30X_BRK_IRQHandler( PWMC_R1_F3_Handle_t * pHandle )
{
