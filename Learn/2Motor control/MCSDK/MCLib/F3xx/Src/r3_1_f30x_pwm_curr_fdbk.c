 ...
 * @retval none
 */
void * R3_1_F30X_TIMx_UP_IRQHandler( PWMC_R3_1_F3_Handle_t * pHandle )
{
 ...
 * @retval none
 */
void * R3_1_F30X_BRK2_IRQHandler( PWMC_R3_1_F3_Handle_t * pHandle )
{
 ...
 * @retval none
 */
void * R3_1_F30X_BRK_IRQHandler( PWMC_R3_1_F3_Handle_t * pHandle )
{
...
uint16_t R3_1_F30X_ExecRegularConv( PWMC_Handle_t * pHdl, uint8_t bChannel )
{
  ...
  LL_ADC_REG_SetSequencerRanks( ADCx,
                                LL_ADC_REG_RANK_1,
