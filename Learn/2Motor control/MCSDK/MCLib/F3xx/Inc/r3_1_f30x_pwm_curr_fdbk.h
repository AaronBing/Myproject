...
typedef struct
{
  ...
  bool BrakeActionLock;     /*!< This flag is set to avoid that brake action is
                                 interrupted.*/
  R3_1_F30XParams_t const * pParams_str;
...
/**
  ...
  */
void * R3_1_F30X_TIMx_UP_IRQHandler( PWMC_R3_1_F3_Handle_t * pHdl );

/**
  * It contains the TIMx break2 event interrupt
  */
void * R3_1_F30X_BRK_IRQHandler( PWMC_R3_1_F3_Handle_t * pHdl );

/**
  * It contains the TIMx break1 event interrupt
  */
void * R3_1_F30X_BRK2_IRQHandler( PWMC_R3_1_F3_Handle_t * pHdl );
/**
