...
/** @addtogroup r3_1_l4xx_pwm_curr_fdbk
  * @{
  */
...
typedef const struct
{
  ...
  ADC_TypeDef * regconvADCx;          /*!< ADC peripheral used for regular
                                           conversion.*/
} R3_1_L4XXParams_t, *pR3_1_L4XXParams_t;


/**
  * @brief  This structure is used to handle an instance of the
  *         r3_1_l4xx_pwm_curr_fdbk component.
  */
typedef struct
{
  ...
  bool BrakeActionLock;     /*!< This flag is set to avoid that brake action is
                                 interrupted.*/
  pR3_1_L4XXParams_t pParams_str;

} PWMC_R3_1_L4_Handle_t;
...
/**
  ...
  */
void * R3_1_L4XX_TIMx_UP_IRQHandler( PWMC_R3_1_L4_Handle_t * pHdl );

/**
  * It contains the TIMx break2 event interrupt
  */
void * R3_1_L4XX_BRK_IRQHandler( PWMC_R3_1_L4_Handle_t * pHdl );

/**
  * It contains the TIMx break1 event interrupt
  */
void * R3_1_L4XX_BRK2_IRQHandler( PWMC_R3_1_L4_Handle_t * pHdl );
