...
#ifndef __R1_F4XX_PWMCURRFDBK_H
#define __R1_F4XX_PWMCURRFDBK_H
...
typedef const struct
{
  ...
  ADC_TypeDef * regconvADCx;         /*!< ADC peripheral used for regular
                                            conversion.*/
} R1_L4XXParams_t, *pR1_L4XXParams_t;
...
/**
  ...
  */
void * R1L4XX_TIMx_UP_IRQHandler( PWMC_R1_L4_Handle_t * pHdl );

/**
  * It contains the TIMx Break2 event interrupt
  */
void * R1L4XX_BRK2_IRQHandler( PWMC_R1_L4_Handle_t * pHdl );

/**
  * It contains the TIMx Break1 event interrupt
  */
void * R1L4XX_BRK_IRQHandler( PWMC_R1_L4_Handle_t * pHdl );
