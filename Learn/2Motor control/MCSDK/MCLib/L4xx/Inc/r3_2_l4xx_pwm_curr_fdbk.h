...
typedef const struct
{
  ...
  ADC_TypeDef * regconvADCx;          /*!< ADC peripheral used for regular
                                           conversion.*/
} R3_2_L4Params_t, *pR3_2_L4Params_t;
...
typedef struct
{
  ...
  bool BrakeActionLock;     /*!< This flag is set to avoid that brake action is
                                 interrupted.*/
  pR3_2_L4Params_t pParams_str;
} PWMC_R3_2_L4_Handle_t;
...
/**
  ...
  */
void * R3_2_L4XX_TIMx_UP_IRQHandler( PWMC_R3_2_L4_Handle_t * pHdl );

/**
  * It contains the TIMx Break2 event interrupt
  */
void * R3_2_L4XX_BRK2_IRQHandler( PWMC_R3_2_L4_Handle_t * pHdl );

/**
  * It contains the TIMx Break1 event interrupt
  */
void * R3_2_L4XX_BRK_IRQHandler( PWMC_R3_2_L4_Handle_t * pHdl );
