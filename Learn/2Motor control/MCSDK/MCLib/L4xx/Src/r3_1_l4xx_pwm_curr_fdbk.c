 ...
 *
 * Instances of this component are managed by a PWMC_R3_1_L4_Handle_t Handle structure that needs
 * to be initialized with the R3_1_L4XX_Init() prior to being used.
 *
 * Usually, the R3_1_L4XX_Init() function i the only function of this component that needs to be
...
static void R3_1_L4XX_HFCurrentsCalibrationAB( PWMC_Handle_t * pHdl, Curr_Components * pStator_Currents );
static void R3_1_L4XX_HFCurrentsCalibrationC( PWMC_Handle_t * pHdl, Curr_Components * pStator_Currents );
static uint16_t R3_1_L4XX_WriteTIMRegisters( PWMC_Handle_t * pHdl, uint16_t hCCR4Reg );
 ...
 * @retval none
 */
void R3_1_L4XX_Init( PWMC_R3_1_L4_Handle_t * pHandle )
{
  ...
  if ( ( uint32_t )pHandle == ( uint32_t )&pHandle->_Super )
  {
    ...
    ADC_InjectedInitStruct.ADC_ExternalTrigInjecConvEvent = pHandle->ADC_ExternalTriggerInjected;
    ADC_InjectedInitStruct.ADC_ExternalTrigInjecEventEdge = LL_ADC_INJ_TRIG_EXT_RISING;
 ...
 * @retval none
 */
void R3_1_L4XX_CurrentReadingCalibration( PWMC_Handle_t * pHdl )
{
  uint16_t hCalibrationPeriodCounter;
  uint16_t hMaxPeriodsNumber;
  PWMC_R3_1_L4_Handle_t * pHandle = ( PWMC_R3_1_L4_Handle_t * )pHdl;
  TIM_TypeDef * TIMx = pHandle->pParams_str->TIMx;
  ...
  pHandle->_Super.pFctGetPhaseCurrents = &R3_1_L4XX_HFCurrentsCalibrationAB;
  pHandle->_Super.pFctSetADCSampPointSect1 = &R3_1_L4XX_SetADCSampPointCalibration;
  pHandle->_Super.pFctSetADCSampPointSect2 = &R3_1_L4XX_SetADCSampPointCalibration;
  pHandle->_Super.pFctSetADCSampPointSect3 = &R3_1_L4XX_SetADCSampPointCalibration;
  pHandle->_Super.pFctSetADCSampPointSect4 = &R3_1_L4XX_SetADCSampPointCalibration;
  pHandle->_Super.pFctSetADCSampPointSect5 = &R3_1_L4XX_SetADCSampPointCalibration;
  pHandle->_Super.pFctSetADCSampPointSect6 = &R3_1_L4XX_SetADCSampPointCalibration;

  pHandle->wADC1_JSQR = pHandle->wADC_JSQR_phAB;

  R3_1_L4XX_SwitchOnPWM( &pHandle->_Super );
  ...
  R3_1_L4XX_SwitchOffPWM( &pHandle->_Super );
  ...
  /* Change function to be executed in ADCx_ISR */
  pHandle->_Super.pFctGetPhaseCurrents = &R3_1_L4XX_HFCurrentsCalibrationC;
  ...
  pHandle->_Super.pFctGetPhaseCurrents = &R3_1_L4XX_GetPhaseCurrents;
  pHandle->_Super.pFctSetADCSampPointSect1 = &R3_1_L4XX_SetADCSampPointSect1;
  pHandle->_Super.pFctSetADCSampPointSect2 = &R3_1_L4XX_SetADCSampPointSect2;
  pHandle->_Super.pFctSetADCSampPointSect3 = &R3_1_L4XX_SetADCSampPointSect3;
  pHandle->_Super.pFctSetADCSampPointSect4 = &R3_1_L4XX_SetADCSampPointSect4;
  pHandle->_Super.pFctSetADCSampPointSect5 = &R3_1_L4XX_SetADCSampPointSect5;
  pHandle->_Super.pFctSetADCSampPointSect6 = &R3_1_L4XX_SetADCSampPointSect6;
 ...
 */
void R3_1_L4XX_GetPhaseCurrents( PWMC_Handle_t * pHdl, Curr_Components * pStator_Currents )
{
  uint8_t bSector;
  int32_t wAux;
  uint16_t hReg1;
 ...
 * @retval none
 */
void R3_1_L4XX_TurnOnLowSides( PWMC_Handle_t * pHdl )
{
  PWMC_R3_1_L4_Handle_t * pHandle = ( PWMC_R3_1_L4_Handle_t * )pHdl;
  TIM_TypeDef * TIMx = pHandle->pParams_str->TIMx;
 ...
 * @param pHdl handler of the current instance of the PWM component
 */
void R3_1_L4XX_SwitchOnPWM( PWMC_Handle_t * pHdl )
{
  PWMC_R3_1_L4_Handle_t * pHandle = ( PWMC_R3_1_L4_Handle_t * )pHdl;
  TIM_TypeDef * TIMx = pHandle->pParams_str->TIMx;
 ...
 * @param pHdl handler of the current instance of the PWM component
 */
void R3_1_L4XX_SwitchOffPWM( PWMC_Handle_t * pHdl )
{
  PWMC_R3_1_L4_Handle_t * pHandle = ( PWMC_R3_1_L4_Handle_t * )pHdl;
  TIM_TypeDef * TIMx = pHandle->pParams_str->TIMx;
  ADC_TypeDef * ADCx = pHandle->pParams_str->ADCx;
 ...
 * @retval none
 */
uint16_t R3_1_L4XX_SetADCSampPointCalibration( PWMC_Handle_t * pHdl )
{
  PWMC_R3_1_L4_Handle_t * pHandle = ( PWMC_R3_1_L4_Handle_t * )pHdl;

  return R3_1_L4XX_WriteTIMRegisters( &pHandle->_Super, ( uint16_t )( pHandle->Half_PWMPeriod ) - 1u );
}
 ...
 * @retval none
 */
uint16_t R3_1_L4XX_SetADCSampPointSect1( PWMC_Handle_t * pHdl )
{
  uint16_t hCntSmp;
  uint16_t hDeltaDuty;
  ...
  return R3_1_L4XX_WriteTIMRegisters( &pHandle->_Super, hCntSmp );
}
 ...
 * @retval none
 */
uint16_t R3_1_L4XX_SetADCSampPointSect2( PWMC_Handle_t * pHdl )
{
  uint16_t hCntSmp;
  uint16_t hDeltaDuty;
  uint32_t wADC_JSQR_phase;  
 ...
 * @retval none
 */
uint16_t R3_1_L4XX_SetADCSampPointSect3( PWMC_Handle_t * pHdl )
{
  uint16_t hCntSmp;
  uint16_t hDeltaDuty;
  uint32_t wADC_JSQR_phase;  
 ...
 * @retval none
 */
uint16_t R3_1_L4XX_SetADCSampPointSect4( PWMC_Handle_t * pHdl )
{
  uint16_t hCntSmp;
  uint16_t hDeltaDuty;
  uint32_t wADC_JSQR_phase;  
 ...
 * @retval none
 */
uint16_t R3_1_L4XX_SetADCSampPointSect5( PWMC_Handle_t * pHdl )
{
  uint16_t hCntSmp;
  uint16_t hDeltaDuty;
  uint32_t wADC_JSQR_phase;  
 ...
 * @retval none
 */
uint16_t R3_1_L4XX_SetADCSampPointSect6( PWMC_Handle_t * pHdl )
{
  uint16_t hCntSmp;
  uint16_t hDeltaDuty;
  uint32_t wADC_JSQR_phase;  
 ...
 * @retval none
 */
void * R3_1_L4XX_TIMx_UP_IRQHandler( PWMC_R3_1_L4_Handle_t * pHandle )
{
 ...
 * @retval none
 */
void * R3_1_L4XX_BRK2_IRQHandler( PWMC_R3_1_L4_Handle_t * pHandle )
{
 ...
 * @retval none
 */
void * R3_1_L4XX_BRK_IRQHandler( PWMC_R3_1_L4_Handle_t * pHandle )
{
 ...
 */
uint16_t R3_1_L4XX_IsOverCurrentOccurred( PWMC_Handle_t * pHdl )
{
  PWMC_R3_1_L4_Handle_t * pHandle = ( PWMC_R3_1_L4_Handle_t * )pHdl;
 ...
 * @retval none
 */
void R3_1_L4XX_RLDetectionModeEnable( PWMC_Handle_t * pHdl )
{
  ADC_InjectedInitTypeDef ADC_InjectedInitStruct;
  PWMC_R3_1_L4_Handle_t * pHandle = ( PWMC_R3_1_L4_Handle_t * )pHdl;
  TIM_TypeDef * TIMx = pHandle->pParams_str->TIMx;
  ...
  if ( pHandle->_Super.RLDetectionMode == false )
  {
    ...
    ADC_InjectedInitStruct.ADC_ExternalTrigInjecConvEvent = LL_ADC_INJ_TRIG_EXT_TIM1_TRGO;
    ADC_InjectedInitStruct.ADC_ExternalTrigInjecEventEdge = LL_ADC_INJ_TRIG_EXT_RISING;
    ADC_InjectedInitStruct.ADC_NbrOfInjecChannel = 2u;
  ...
  pHandle->_Super.pFctGetPhaseCurrents = &R3_1_L4XX_RLGetPhaseCurrents;
  pHandle->_Super.pFctTurnOnLowSides = &R3_1_L4XX_RLTurnOnLowSides;
  pHandle->_Super.pFctSwitchOnPwm = &R3_1_L4XX_RLSwitchOnPWM;
  pHandle->_Super.pFctSwitchOffPwm = &R3_1_L4XX_RLSwitchOffPWM;
 ...
 * @retval none
 */
void R3_1_L4XX_RLDetectionModeDisable( PWMC_Handle_t * pHdl )
{
  PWMC_R3_1_L4_Handle_t * pHandle = ( PWMC_R3_1_L4_Handle_t * )pHdl;
  TIM_TypeDef * TIMx = pHandle->pParams_str->TIMx;
  ...
  if ( pHandle->_Super.RLDetectionMode == true )
  {
    ...
    pHandle->_Super.pFctGetPhaseCurrents = &R3_1_L4XX_GetPhaseCurrents;
    pHandle->_Super.pFctTurnOnLowSides = &R3_1_L4XX_TurnOnLowSides;
    pHandle->_Super.pFctSwitchOnPwm = &R3_1_L4XX_SwitchOnPWM;
    pHandle->_Super.pFctSwitchOffPwm = &R3_1_L4XX_SwitchOffPWM;
 ...
 */
uint16_t R3_1_L4XX_RLDetectionModeSetDuty( PWMC_Handle_t * pHdl, uint16_t hDuty )
{
  PWMC_R3_1_L4_Handle_t * pHandle = ( PWMC_R3_1_L4_Handle_t * )pHdl;
  uint16_t hAux;
   ...
   * the R3_1_L4XX_RLDetectionModeEnable function*/
 ...
 * @retval Ia and Ib current in Curr_Components format
 */
void R3_1_L4XX_RLGetPhaseCurrents( PWMC_Handle_t * pHdl, Curr_Components * pStator_Currents )
{
  int32_t wAux;
  PWMC_R3_1_L4_Handle_t * pHandle = ( PWMC_R3_1_L4_Handle_t * )pHdl;
  ADC_TypeDef * ADCx = pHandle->pParams_str->ADCx;
  ...
  wAux = (int32_t)(pHandle->wPhaseBOffset) - (int32_t)(ADCx->JDR1);
  ...
  wAux = (int32_t)(pHandle->wPhaseBOffset) - (int32_t)(ADCx->JDR2);
 ...
 * @retval none
 */
void R3_1_L4XX_RLTurnOnLowSides( PWMC_Handle_t * pHdl )
{
  PWMC_R3_1_L4_Handle_t * pHandle = ( PWMC_R3_1_L4_Handle_t * )pHdl;
  TIM_TypeDef * TIMx = pHandle->pParams_str->TIMx;
 ...
 * @retval none
 */
void R3_1_L4XX_RLSwitchOnPWM( PWMC_Handle_t * pHdl )
{
  PWMC_R3_1_L4_Handle_t * pHandle = ( PWMC_R3_1_L4_Handle_t * )pHdl;
  TIM_TypeDef * TIMx = pHandle->pParams_str->TIMx;
  ...
  LL_TIM_SetRepetitionCounter(TIMx, 0u);
 ...
 * @retval none
 */
void R3_1_L4XX_RLSwitchOffPWM( PWMC_Handle_t * pHdl )
{
  PWMC_R3_1_L4_Handle_t * pHandle = ( PWMC_R3_1_L4_Handle_t * )pHdl;
  TIM_TypeDef * TIMx = pHandle->pParams_str->TIMx;
  ADC_TypeDef * ADCx = pHandle->pParams_str->ADCx;
...
void RLTurnOnLowSidesAndStart( PWMC_Handle_t * pHdl )
{
  ...
  ADCx->JSQR = pHandle->wADC_JSQR_phAB|LL_ADC_INJ_TRIG_EXT_RISING;
  /* ADCx Injected conversions end interrupt enabling */
  LL_ADC_ClearFlag_JEOS( pHandle->pParams_str->ADCx );
  LL_ADC_EnableIT_JEOS( pHandle->pParams_str->ADCx );
