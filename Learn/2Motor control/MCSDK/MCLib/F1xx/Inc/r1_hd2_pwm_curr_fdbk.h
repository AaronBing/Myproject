...
typedef struct
{
	...
	volatile uint8_t  bIndex;   /**< Number of conversions performed during the calibration phase*/
...
void R1HD2_GetPhaseCurrents( PWMC_Handle_t * pHandle, Curr_Components* pStator_Currents );
