...
static void R1VL1_TIMxInit( TIM_TypeDef* TIMx, TIM_TypeDef* TIMx_2, PWMC_R1_VL1_Handle_t * pHandle );
static void R1VL1_1ShuntMotorVarsInit( PWMC_R1_VL1_Handle_t * pHandle );
static void R1VL1_1ShuntMotorVarsRestart( PWMC_R1_VL1_Handle_t * pHandle );
...
/**
  ...
  */
void R1VL1_GetPhaseCurrents( PWMC_Handle_t * pHandle, Curr_Components* pStatorCurrents )
{  
  int32_t wAux;
 ...
 * @param pHandle Handle on the PWMC component in charge of the target motor
 */
void R1VL1_TurnOnLowSides( PWMC_Handle_t * pHdl )
{
 ...
 * @param pHandle Handle on the PWMC component in charge of the target motor
 */
void R1VL1_SwitchOnPWM( PWMC_Handle_t * pHdl )
{
  PWMC_R1_VL1_Handle_t *pHandle = (PWMC_R1_VL1_Handle_t *) pHdl;
 ...
 * @param pHandle Handle on the PWMC component in charge of the target motor
 */
void R1VL1_SwitchOffPWM( PWMC_Handle_t * pHdl )
{
  uint16_t hAux;
  PWMC_R1_VL1_Handle_t *pHandle = (PWMC_R1_VL1_Handle_t *) pHdl;
 ...
 */
uint16_t R1VL1_CalcDutyCycles( PWMC_Handle_t * pHdl )
{
  TIM_TypeDef* TIMx;
 ...
 */
uint16_t R1VL1_IsOverCurrentOccurred( PWMC_Handle_t * pHdl )
{
  PWMC_R1_VL1_Handle_t * pHandle = (PWMC_R1_VL1_Handle_t *) pHdl;
