...
typedef struct
{
  ...
  uint16_t hRegConv;            /*!< Variable used to store regular conversions
                                 *   result*/
  /* Add here extra variables required by G0xx micro ex. User conversions.*/
  ...
  R3_G0XXParams_t const * pParams_str;
...
/**
  ...
  */
uint16_t R3G0XX_ExecRegularConv(PWMC_Handle_t *pHdl, uint8_t bChannel);
...
/**
  ...
  */
void R3G0XX_ADC_SetSamplingTime(PWMC_Handle_t *pHdl, ADConv_t ADConv_struct);
