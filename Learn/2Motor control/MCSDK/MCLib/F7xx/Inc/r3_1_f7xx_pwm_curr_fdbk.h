...
/**
  * @brief  r3_1_f7xx_pwm_curr_fdbk component parameters definition
  */
typedef const struct
{
  ...
  ADC_TypeDef * regconvADCx;          /*!< ADC peripheral used for regular
                                           conversion.*/
} R3_1_F7_Params_t, *pR3_1_F7_Params_t;
...
typedef struct
{
  ...
  uint32_t ADC_ExternalTriggerEdge;     /* external ADC trigger edge */
  ...
  bool BrakeActionLock;     /*!< This flag is set to avoid that brake action is
                                 interrupted.*/
  pR3_1_F7_Params_t pParams_str;

} PWMC_R3_1_F7_Handle_t;
...
/**
  ...
  */
void * R3_1_F7XX_TIMx_UP_IRQHandler( PWMC_R3_1_F7_Handle_t * pHdl );

/**
  * It contains the TIMx break2 event interrupt
  */
void * R3_1_F7XX_BRK_IRQHandler( PWMC_R3_1_F7_Handle_t * pHdl );

/**
  * It contains the TIMx break1 event interrupt
  */
void * R3_1_F7XX_BRK2_IRQHandler( PWMC_R3_1_F7_Handle_t * pHdl );
