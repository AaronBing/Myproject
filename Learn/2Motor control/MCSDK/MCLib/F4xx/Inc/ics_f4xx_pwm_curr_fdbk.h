...
void * IF4XX_IRQHandler( PWMC_Handle_t * pHandle, unsigned char flag );

uint16_t IF4XX_ExecRegularConv( PWMC_Handle_t * pHandle, uint8_t bChannel );
...
void * IF4XX_BRK_IRQHandler( PWMC_ICS_F4_Handle_t * pHdl );
